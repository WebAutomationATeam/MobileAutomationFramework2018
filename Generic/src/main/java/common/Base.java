...
public class Base {
    ...
    @BeforeMethod
    public void setUp(@Optional("Android") String OS,@Optional("Phone") String appType,@Optional("Real Device") String deviceType,@Optional("Galaxy Edge s7") String deviceName,
                      @Optional("8.0")String version)throws IOException,InterruptedException{

        if(OS.equalsIgnoreCase("ios")){
            if(appType.contains("iPhone")){
                appDirectory = new File("C:\\Users\\Rob Dos\\Desktop\\Robin\\MobileNov2018\\UiCatalog\\src\\app\\UICatalog6.1.app.zip");
            ...
            if(appType.contains("Phone")){
                appDirectory = new File("C:\\Users\\Rob Dos\\Desktop\\Robin\\MobileNov2018\\NYP\\src\\app\\nyp.apk");
